...
#DONT PUSH API KEY TO REPO 
#Create cluster - save username and password and api key ( in notepad )


#cluster - warehouse with database 
# collection = table 
...
class DatabaseManager: 
    ...
    def init_database(self):
        ...
        #Create index on user_id for posts for better query performace 
